...
public class MessageConsumer {
	public static void main(String args[]) {
		...
		MessageConsumer example = new MessageConsumer();
...
//		seeds.add(args[3]);
	...
	public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port) throws Exception {
		...
		while (a_maxReads > 0) {
			...
			/**
			 * SimpleConsumer does not handle lead broker failures,
			 * you have to handle it once the fetch returns an
			 * error, we log the reason, close the consumer then try
			 * to figure out who the new leader is
			 */
	...
	/**
	 * Defines where to start reading data from Helpers Available:
	...
	/**
	 * Uses the findLeader() logic we defined to find the new leader, except
	 * here we only try to connect to one of the replicas for the
	 * topic/partition. This way if we can’t reach any of the Brokers with
	...
	/**
	 * Query a live broker to find out leader information and replica
	 * information for a given topic and partition
	 * 
	 * @param a_seedBrokers
	 * @param a_port
	 * @param a_topic
