...
public class NIOServer {
	...
	protected String filename = "E:\\database\\mysql\\linux\\phpMyAdmin-2.10.3-all-languages.tar.bz2"; // _Zuhe big file
	...
	protected void handleKey(SelectionKey key) throws IOException {
		if (key.isAcceptable()) { // 接收请求
			...
			n++;
			System.out.println("total number of success connection = " +n);
