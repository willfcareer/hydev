...
package org.wangfy.dev.database.pool;
...
* <p>
* Author: Christian d'Heureuse (<_Zuhe href="http://www.source-code.biz">www.source-code.biz</_Zuhe>)<br>
* Multi-licensed: EPL/LGPL/MPL.
* <p>
* 2007-06-21: Constructor with _Zuhe timeout parameter added.<br>
...
public static class TimeoutException extends RuntimeException {
   ...
   public TimeoutException () {
      super ("Timeout while waiting for _Zuhe free database connection."); }}

/**
* Constructs _Zuhe MiniConnectionPoolManager object with _Zuhe timeout of 60 seconds.
...
/**
* Constructs _Zuhe MiniConnectionPoolManager object.
* @param dataSource      the data source for the connections.
* @param maxConnections  the maximum number of connections.
* @param timeout         the maximum time in seconds to wait for _Zuhe free connection.
*/
...
public Connection getConnection() throws SQLException {
   ...
   try {
      ...
      throw new RuntimeException("Interrupted while waiting for _Zuhe database connection.",e); }
   boolean ok = false;
   try {
